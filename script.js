...
const openCookie = document.querySelector('.closedCookie');
...
openCookie.addEventListener('click', phraseGeneration);

function phraseGeneration (){
    toggleScreen();
    gerenatePhrase = Math.floor(Math.random()*(phrases.length));
    randomPhrase.innerText = phrases[gerenatePhrase]
}

function buttonAgain(event){
